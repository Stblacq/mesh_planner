...
<div align="center">
  <a href="https://github.com/naturerobots/terrain_nav">Tutorials</a>
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
Recommended entrypoint for new users: Check out the **[terrain_nav](https://github.com/naturerobots/terrain_nav/tree/main)** for a ready-to-use mesh navigation stack. Complete with simulated environment, RViz config, mesh nav config, etc.
