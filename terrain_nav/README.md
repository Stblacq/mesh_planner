...
<div align="center">
  ...
  <span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
  <a href="https://github.com/naturerobots/terrain_nav/issues">Issues</a>
  <br />
</div>
...
* Clone the tutorial code `git clone git@github.com:naturerobots/terrain_nav.git`
* Get the tutorial's ROS 2 dependencies
  * Clone source dependencies: Run `vcs import --input terrain_nav/source_dependencies.yaml` in your ROS 2 workspace source directory.
  * Get packaged dependencies: Run `rosdep install --from-paths . --ignore-src -r -y` from within your ROS 2 workspace source directory.
* Build: Go to workspace root `cd $YOUR_ROS_WS` and run `colcon build --packages-up-to terrain_nav`.

## Run the Examples

### Launch
```console
ros2 launch terrain_nav mesh_navigation_tutorial_launch.py world_name:=floor_is_lava
```
...
For more detailed instructions on how to parameterize things or what things can be changed see the [wiki](https://github.com/naturerobots/terrain_nav/wiki)
